...
public:
	...
	void SetRadiusInnerPad(G4double val){innerPadRadius = val;}
	void SetRadiusOuterPad(G4double val){outerPadRadius = val;}
	...
	G4double GetRadiusInnerPad(void){return innerPadRadius;}
	G4double GetRadiusOuterPad(void){return outerPadRadius;}
