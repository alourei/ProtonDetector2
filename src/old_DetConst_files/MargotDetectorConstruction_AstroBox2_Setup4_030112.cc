...
MargotDetectorConstruction::MargotDetectorConstruction(G4String DetType, G4double Thick, G4double DegRot)
 :solidWorld(0),  logicWorld(0),  physiWorld(0),
  ...
  physiMicroBulk1(0), physiMicroBulk2(0), physiMicroBulk3(0), physiMicroBulk4(0),
...
G4VPhysicalVolume* MargotDetectorConstruction::Construct()
{
 ...
 // retangular for AstroBox2!
  ...
  G4double IonChamberP1z = 165.5*mm;   
  ...
  solidIonChamberP1 = new G4Box("IonChamberP1",IonChamberP1x/2.,IonChamberP1y/2.,IonChamberP1z/2.);
    ...
    G4double halfHeightICP2 = (185.5/2.)*mm;
 ...
 // Visualization (is it there?)
  ...
  // The chamber interior with gas
    ...
    G4double halfHeightICGasP2 = ((185.5/2.))*mm;
...
// Ion Chamber Window
 ...
 // Now simulated as "Box" Volumes
  ...
  // -----------------------------------------
  // New Pad Dimensions, Calculated 2/8/2012 (as per email 12/20/2011)
  // Now there are 4 MicroBulk pads
  // -----------------------------------------
    ...
    G4ThreeVector positionMicroBulk1 = G4ThreeVector(0.0,0.0,-1.5*(MicroBulkZ+DeadZoneGapSize)); // w.r.t. Ion Chamber Gas
    ...
    G4ThreeVector positionMicroBulk2 = G4ThreeVector(0.0,0.0,-0.5*(MicroBulkZ+DeadZoneGapSize)); // w.r.t. Ion Chamber Gas
    ...
    G4ThreeVector positionMicroBulk3 = G4ThreeVector(0.0,0.0,0.5*(MicroBulkZ+DeadZoneGapSize)); // w.r.t. Ion Chamber Gas
    ...
    G4ThreeVector positionMicroBulk4 = G4ThreeVector(0.0,0.0,1.5*(MicroBulkZ+DeadZoneGapSize)); // w.r.t. Ion Chamber Gas
 ...
 // Visualization (is it there?)
  ...
  G4double BulkTBz = (MicroBulkZ*2.+20.)*mm;  // 20.0*2+20, see MicroBulkz above
    ...
    G4ThreeVector positionBulkTop1 = G4ThreeVector(0.0,(BulkTBy/2.+MicroBulkY/2.+1.0*mm),-(10.0*mm+MicroBulkZ)); // w.r.t. Ion Chamber
    ...
    G4ThreeVector positionBulkTop2 = G4ThreeVector(0.0,(BulkTBy/2.+MicroBulkY/2.+1.0*mm),(10.0*mm+MicroBulkZ)); // w.r.t. Ion Chamber
    ...
    G4ThreeVector positionBulkBottom1 = G4ThreeVector(0.0,-(BulkTBy/2.+MicroBulkY/2.+1.0*mm),-(10.0*mm+MicroBulkZ)); // w.r.t. Ion Chamber
    ...
    G4ThreeVector positionBulkBottom2 =  G4ThreeVector(0.0,-(BulkTBy/2.+MicroBulkY/2.+1.0*mm),(10.0*mm+MicroBulkZ)); // w.r.t. Ion Chamber
  ...
  G4double BulkFBz = 20.0*mm;
    ...
    G4ThreeVector positionBulkFront = G4ThreeVector(0.0,0.0,-(1.0*mm+2.*MicroBulkZ+BulkFBz/2.)); // w.r.t. Ion Chamber
    ...
    G4ThreeVector positionBulkBack = G4ThreeVector(0.0,0.0,(1.0*mm+2.*MicroBulkZ+BulkFBz/2.)); // w.r.t. Ion Chamber
 ...
 // Visualization (is it there?)
  ...
  G4double BeamCounterZ = 10.0*mm;
    ...
    G4ThreeVector positionBeamCounterFront = G4ThreeVector(0.0,0.0,-(1.0*mm+2.*MicroBulkZ+BulkFBz+BeamCounterZ/2.)); // w.r.t. Ion Chamber
    ...
    G4ThreeVector positionBeamCounterBack = G4ThreeVector(0.0,0.0,(1.0*mm+2.*MicroBulkZ+BulkFBz+BeamCounterZ/2.)); // w.r.t. Ion Chamber
